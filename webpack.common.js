...
module.exports = {
    ...
    plugins: [
        ...
        new WebpackPwaManifest({
          ...
          screenshots: [
            {
              src: path.resolve('./src/public/images/screenshots/screenshots-1.png'),
              sizes: '586x1041',
              destination: path.join('/images/screenshots/', 'preview'),
              type: 'image/png',
              form_factor: 'wide',
            ...
            {
              src: path.resolve('./src/public/images/screenshots/screenshots-2.png'),
              sizes: '586x1041',
              destination: path.join('/images/screenshots/', 'preview'),
              type: 'image/png',
              form_factor: 'narrow',
            ...
            {
              src: path.resolve('./src/public/images/screenshots/screenshots-3.png'),
              sizes: '586x1041',
              destination: path.join('/images/screenshots/', 'preview'),
              type: 'image/png',
              form_factor: 'narrow',
