...
module.exports = {
    ...
    plugins: [
        ...
        new WebpackPwaManifest({
          ...
          screenshots: [
            {
              src: 'https://drive.google.com/file/d/1zQFeMPa3IgqfYWUSt1hXJwbluVcUERoO/view?usp=drive_link',
              sizes: '586x1041',
            ...
            {
              src: 'https://drive.google.com/file/d/1hGnnCF5GImBvJkG6I0gNxdOsUg5bz0aZ/view?usp=drive_link',
              sizes: '586x1041',
              // destination: path.join('/images/screenshots/', 'preview'),
              type: 'image/png',
              // form_factor: 'narrow',
            ...
            {
              src: 'https://drive.google.com/file/d/1zuhdVDRYTl4Lcve9DOZnZ4VAkCR0Vt-x/view?usp=drive_link',
              sizes: '586x1041',
              // destination: path.join('/images/screenshots/', 'preview'),
              type: 'image/png',
              // form_factor: 'narrow',
