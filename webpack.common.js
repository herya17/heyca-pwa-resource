...
module.exports = {
    ...
    plugins: [
        ...
        new WebpackPwaManifest({
          ...
          screenshots: [
            {
              src: path.resolve('./src/public/images/screenshots/screenshots-1.gif'),
              sizes: '586x1041',
            ...
            {
              src: path.resolve('./src/public/images/screenshots/screenshots-2.gif'),
              sizes: '586x1041',
              destination: path.join('/images/screenshots/', 'preview'),
              type: 'image/gif',
              form_factor: 'narrow',
            ...
            {
              src: path.resolve('./src/public/images/screenshots/screenshots-3.gif'),
              sizes: '586x1041',
              destination: path.join('/images/screenshots/', 'preview'),
              type: 'image/gif',
              form_factor: 'narrow',
